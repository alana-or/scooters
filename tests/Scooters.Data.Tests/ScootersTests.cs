...
public class ScootersTests
{
    ...
    public async Task Create_Should_Create_Scooter()
    {
        using (var _scope = _serviceProvider.CreateScope())
        {
            ...
            var scooter = new ScooterDB { Id = 101, Year = 2023, Model = "Model", LicencePlate = "123" };
    ...
    public async Task Update_Should_Update_Scooter()
    {
        using (var _scope = _serviceProvider.CreateScope())
        {
            ...
            var scooter = new ScooterDB { Id = 101, Year = 2023, Model = "Old Model", LicencePlate = "OLD123" };
    ...
    public async Task GetScooterAsync_Should_Return_Specific_Scooter_When_LicencePlate_Is_Provided()
    {
        using (var _scope = _serviceProvider.CreateScope())
        {
            ...
            var specificScooter = new ScooterDB { Year = 2023, Model = "Specific Model", LicencePlate = "ABC123" };
